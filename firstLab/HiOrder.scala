...
def nTimes(f:(Int, Int) => Int, a, Int, b: Int, n:  Int): Int = n* f(a, b);
  ...
  println("Testing testNTimes(plus, 1, 2, 3):\t"+ testNTimes(plus, 1, 2, 3))
  println("Testing testAnonymousNTimes(2,3,3):\t"+ testAnonymousNTimes(2, 3, 2))
  println("Testing AnonymousNTimes(5,6,3):\t"+ testAnonymousNTimes(5, 6, 3))
}
